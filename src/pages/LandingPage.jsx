...
import { Dumbbell, ShieldCheck, Zap, TrendingUp, Users, CreditCard, CheckCircle, ArrowRight, Star, Heart } from 'lucide-react';
  ...
  return (
    <div style={{ background: '#09090b', color: '#fff', fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
      ...
      <section style={{ paddingTop: '10rem', paddingBottom: '8rem', position: 'relative' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '4rem', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          <div>
            ...
            <h1 style={{ fontSize: '5rem', fontWeight: 900, lineHeight: 0.9, letterSpacing: '-3px', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '1.4rem', color: '#94a3b8', lineHeight: 1.5, marginBottom: '3rem', maxWidth: '500px' }}>
            ...
            <div style={{ marginTop: '4rem', display: 'flex', gap: '3rem', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600, marginLeft: '0.5rem' }}>Top-Rated SaaS</span>
              </div>
            </div>
          </div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {/* Floating UI Badges */}
            <div style={{ position: 'absolute', top: '-20px', right: '-20px', background: 'rgba(139, 92, 246, 0.95)', padding: '1rem 1.5rem', borderRadius: '16px', backdropFilter: 'blur(10px)', zIndex: 3, boxShadow: '0 20px 40px rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div style={{ position: 'absolute', bottom: '40px', left: '-40px', background: 'rgba(16, 185, 129, 0.95)', padding: '1rem 1.5rem', borderRadius: '16px', backdropFilter: 'blur(10px)', zIndex: 3, boxShadow: '0 20px 40px rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <TrendingUp size={24} color="#fff" />
              <div>
                <p style={{ margin: 0, fontWeight: 800, fontSize: '0.9rem' }}>+40% Efficiency</p>
                <p style={{ margin: 0, fontSize: '0.7rem', opacity: 0.8 }}>Automated Operations</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" style={{ padding: '10rem 0', background: '#0c0c0e' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, letterSpacing: '-2px', marginBottom: '1.5rem' }}>Unfair Advantage Tools</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2.5rem' }}>
            <div className="feature-card" style={{ padding: '3rem', borderRadius: '32px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', transition: 'all 0.3s' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#8b5cf6', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer' }}>
            ...
            <div className="feature-card" style={{ padding: '3rem', borderRadius: '32px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', transition: 'all 0.3s' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#10b981', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer' }}>
                Learn More <ArrowRight size={16} />
              </div>
            </div>
            ...
            <div className="feature-card" style={{ padding: '3rem', borderRadius: '32px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', transition: 'all 0.3s' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#3b82f6', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer' }}>
                Learn More <ArrowRight size={16} />
              </div>
            </div>
          </div>
      ...
      <section id="pricing" style={{ padding: '10rem 0' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, letterSpacing: '-2px', marginBottom: '1.5rem' }}>Simple, Transparent Pricing</h2>
            <p style={{ fontSize: '1.2rem', color: '#94a3b8' }}>Scale from one boutique studio to a nationwide franchise.</p>
          </div>
          
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
            <div style={{ padding: '4rem', borderRadius: '40px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
               ...
               <ul style={{ listStyle: 'none', padding: 0, marginBottom: '4rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  <li style={{ display: 'flex', alignItems: 'center', gap: '12px' }}><CheckCircle size={18} color="#10b981" /> Basic Reporting</li>
                  <li style={{ display: 'flex', alignItems: 'center', gap: '12px', opacity: 0.5 }}><XCircle size={18} /> No Trainer Portal</li>
               </ul>
            ...
            <div style={{ padding: '4rem', borderRadius: '40px', background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(99, 102, 241, 0.1))', border: '2px solid #8b5cf6', position: 'relative' }}>
               ...
               <ul style={{ listStyle: 'none', padding: 0, marginBottom: '4rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  <li style={{ display: 'flex', alignItems: 'center', gap: '12px' }}><CheckCircle size={18} color="#10b981" /> 5 Trainer Portal Licenses</li>
               </ul>
      ...
      <section style={{ padding: '10rem 0', background: 'linear-gradient(to bottom, #09090b, #0c0c0e)' }}>
         <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem', textAlign: 'center' }}>
            <h2 style={{ fontSize: '4.5rem', fontWeight: 900, letterSpacing: '-3px', marginBottom: '2rem' }}>Ready to build your <br/><span style={{ color: '#8b5cf6' }}>Gym Empire?</span></h2>
